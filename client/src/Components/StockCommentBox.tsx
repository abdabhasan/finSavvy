...
type Props = {
  symbol: string;
  handleCommentSubmit: (e: CommentFormInputs) => void;
};
...
const StockCommentBox = ({ symbol, handleCommentSubmit }: Props) => {
  ...
  return (
    <form className="mt-4 ml-4" onSubmit={handleSubmit(handleCommentSubmit)}>
      <input
        type="text"
        id="title"
...
export default StockCommentBox;
